      ...
      <div className="flex items-center space-x-2" onClick={e => e.stopPropagation()}>
        {isEditing ? (
          <div className="flex items-center space-x-1">
            <input
              ...
              step="0.5"
              placeholder="min"
              className="w-14 text-right font-mono text-sm rounded-md px-2 py-1 focus:outline-none focus:ring-2"
              style={{
            ...
            />
            <span className="text-xs" style={{ color: 'rgba(184,134,11,0.6)' }}>min</span>
          </div>
        ) : (
        ...
        {isEditable && !isEditing && (
          <button
            ...
            className="flex items-center space-x-1 px-2 py-1 rounded transition-colors hover:bg-amber-900/30"
            style={{ color: 'rgba(184,134,11,0.65)' }}
            onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = '#FBBF24'}
            onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = 'rgba(184,134,11,0.65)'}
